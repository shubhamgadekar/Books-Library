...
class BookRepositoryImpl
    ...
    constructor(
        ...
        override fun isBookPresentInFavList(book: Book): Flow<Boolean> =
            flow {
        ...
        override fun isBookPresentInReadingList(book: Book): Flow<Boolean> =
            flow {
        ...
        override fun getFavListBooks(): Flow<List<Book>> =
            flow {
                emit(
        ...
        override fun getReadingListBooks(): Flow<List<Book>> =
            flow {
                emit(
